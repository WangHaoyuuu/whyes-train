...
+    # Ensure test loss is present and is a finite value
+    assert "test/loss" in test_metric_dict
+    assert hasattr(test_metric_dict["test/loss"], "item")
+    assert test_metric_dict["test/loss"].item() == test_metric_dict["test/loss"].item()
